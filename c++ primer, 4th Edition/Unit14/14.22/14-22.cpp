...
public:
	...
	const Screen *operator->() const { return ptr->sp; }
	friend inline bool operator==(const ScreenPtr &sp1, const ScreenPtr &sp2);
	friend inline bool operator!=(const ScreenPtr &p1, const ScreenPtr &p2);
private:
	ScrPtr *ptr; 
};
...
inline bool operator==(const ScreenPtr &sp1, const ScreenPtr &sp2)
{
